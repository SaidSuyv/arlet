...
INSERT INTO currency(country,currency,iso) VALUES
  ...
  ("ANTARCTICA", "No universal currency", "nan") ,
  ...
  ("PALAU", "US Dollar", "USD") ,
  ("PALESTINE, STATE OF", "No universal currency", "nan") ,
  ("PANAMA", "Balboa", "PAB") ,
  ...
  ("SOUTH GEORGIA AND THE SOUTH SANDWICH ISLANDS", "No universal currency", "nan") ,
